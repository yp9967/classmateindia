...
function AdminPage() {
  ...
  function allocate() {
    fetch("https://us-central1-classmateindia-56f85.cloudfunctions.net/app/allocateClassrooms", {
      method: "POST",
    })
      .then((res) => res.json())
    };
  ...
  return (
    <div className="admin-container">
      <div className="admin-head">
        ...
        {data.length >= 10 && (
          <button className="admin-assign-btn" onClick={allocate()}>Assign Classroom</button>
        )}
      </div>
        ...
        {data.map((i) => {
          return (
            <div className="admin-user-card">
              <span className="admin-user-name"><b>Classroom:  <span style={{ color: "green" }}>{i.classroomId}</span></b></span>
